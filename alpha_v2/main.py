...
np.savetxt('grad_x.dat', matrices.grad_own[0], fmt='%1.3f')
np.savetxt('grad_y.dat', matrices.grad_own[1], fmt='%1.3f')
np.savetxt('grad_norm.dat', matrices.grad_own[4], fmt='%1.3f')
np.savetxt('pressure.dat', matrices.pressure, fmt='%1.3f')
