...
\begin{figure}[htbp]
      \centering
      \begin{subfigure}{.45\textwidth}
            \includegraphics[width=.99\linewidth]{beta/figures/potential_obstacle_Nx=30_Ny=60.pdf}
            \caption{Velocity potential field}
      \end{subfigure}
      \begin{subfigure}{.45\textwidth}
            \includegraphics[width=.99\linewidth]{beta/figures/velocity_obstacle_Nx=30_Ny=60.pdf}
            \caption{Velocity field}
      \end{subfigure}

      \centering
      \begin{subfigure}{.45\textwidth}
            \includegraphics[width=.99\linewidth]{beta/figures/streamlines_obstacle_Nx=30_Ny=60.pdf}
            \caption{Streamlines}
      \end{subfigure}
      \begin{subfigure}{.45\textwidth}
            \includegraphics[width=.99\linewidth]{beta/figures/pressure_obstacle_Nx=30_Ny=60.pdf}
...
\begin{figure}[htbp]
      \centering
      \begin{subfigure}{.45\textwidth}
            \includegraphics[width=.99\linewidth]{beta/figures/potential_obstacle_Nx=60_Ny=30.pdf}
            \caption{Velocity potential field}
      \end{subfigure}
      \begin{subfigure}{.45\textwidth}
            \includegraphics[width=.99\linewidth]{beta/figures/velocity_obstacle_Nx=60_Ny=30.pdf}
            \caption{Velocity field}
      \end{subfigure}

      \centering
      \begin{subfigure}{.45\textwidth}
            \includegraphics[width=.99\linewidth]{beta/figures/streamlines_obstacle_Nx=60_Ny=30.pdf}
            \caption{Streamlines}
      \end{subfigure}
      \begin{subfigure}{.45\textwidth}
            \includegraphics[width=.99\linewidth]{beta/figures/pressure_obstacle_Nx=60_Ny=30.pdf}
            \caption{Pressure field}
      \end{subfigure}
      \caption{Results for \py{Nx} = \py{Ny} = \num{60} in an obstacle geometry}
\end{figure}
