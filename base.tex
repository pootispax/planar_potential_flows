...
\begin{figure}[htbp]
      ...
      \begin{subfigure}{.45\textwidth}
            \includegraphics[width=.99\linewidth]{figures/potential_shrinkage_Nx=60_Ny=60.pdf}
            \caption{Velocity potential field}\label{fig:vel_pot_field}
      \end{subfigure}
      \begin{subfigure}{.45\textwidth}
            \includegraphics[width=.99\linewidth]{figures/velocity_shrinkage_Nx=60_Ny=60.pdf}
            \caption{Velocity field}\label{fig:velocity_field}
      \end{subfigure}

      \centering
      \begin{subfigure}{.45\textwidth}
            \includegraphics[width=.99\linewidth]{figures/streamlines_shrinkage_Nx=60_Ny=60.pdf}
            \caption{Streamlines}\label{fig:streamlines}
      \end{subfigure}
      \begin{subfigure}{.45\textwidth}
            \includegraphics[width=.99\linewidth]{figures/pressure_shrinkage_Nx=60_Ny=60.pdf}
