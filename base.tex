...
The function \textcolor{func}{\py{section()}} takes 2 input arguments.
\begin{itemize}
...
The function \textcolor{func}{\py{section_wid_shrin()}} takes 2 input
arguments.
\begin{itemize}
...
in the \py{grad_x} and \py{grad_y} arrays.

We then plot the 2 lists of data with some information and save them.

\subsubsection{\py{section_elbow()}}
The function \textcolor{func}{\py{section_elbow()}} takes 5 input arguments.
\begin{itemize}
      \item \py{grad_x:} \textcolor{dtype}{np.array}
      \item \py{grad_y:} \textcolor{dtype}{np.array}
...
values of the first half) and the indices in \py{grad_x} and \py{grad_y} are
inverted.

We then plot the 2 lists of data with some information and save them.

\subsubsection{\py{section_obstacle()}}
The function \textcolor{func}{\py{section_obstacle()}} takes ' input arguments.
\begin{itemize}
      \item \py{grad_x:} \textcolor{dtype}{np.array}
      \item \py{grad_y:} \textcolor{dtype}{np.array}
      \item \py{xpart:} \textcolor{dtype}{int}
...
a quick workaround using the \textcolor{func}{\py{interp}} function from
\py{plot.py} is possible to increase the number of points. All the computation
