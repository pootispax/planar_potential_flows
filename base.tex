...
\begin{figure}[htbp]
      ...
      \begin{subfigure}{.45\textwidth}
            \includegraphics[scale=.5]{alpha_v2/figures/potential_shrinkage_Nx=60_Ny=60.pdf}
            \caption{Velocity potential field}\label{fig:vel_pot_field}
      \end{subfigure}
      \begin{subfigure}{.45\textwidth}
            \includegraphics[scale=.5]{alpha_v2/figures/velocity_shrinkage_Nx=60_Ny=60.pdf}
            \caption{Velocity field}\label{fig:velocity_field}
      \end{subfigure}

      \centering
      \begin{subfigure}{.45\textwidth}
            \includegraphics[scale=.5]{alpha_v2/figures/streamlines_shrinkage_Nx=60_Ny=60.pdf}
            \caption{Streamlines}\label{fig:streamlines}
      \end{subfigure}
      \begin{subfigure}{.45\textwidth}
            \includegraphics[scale=.5]{alpha_v2/figures/pressure_shrinkage_Nx=60_Ny=60.pdf}
...
As seen in \autoref{fig:velocity_field}, bla bla bla and bla
\newpage
\cite{potential-flow}
\newpage
\begin{multicols}{2}
